...
def add_extra_arguments(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument("--mode", type=str, default="normal", help="Attention Type (e.g., normal, slerp, lerp, ...).")
    parser.add_argument("--dift_timestep", type=int, default=700, help="DIFT timestep.")
    parser.add_argument("--movement_intensifier", type=float, default=0.3, help="Movement intensifier factor.")
...
def add_editing_arguments(parser: argparse.ArgumentParser) -> None:
    parser.add_argument("--max_norm_zs", type=float, nargs="+", default=None, 
                        help="A list of floats for max_norm_zs.")
    parser.add_argument("--noise_shift_delta", type=float, default=1)
    parser.add_argument("--noise_timesteps", type=int, nargs="+", default=None, 
    ...
    parser.add_argument("--num_steps_inversion", type=int, default=6)
